...
if __name__=="__main__":
    ...
    map_names = {"gridworld": "grid_64x64_map1", "taxiworld": "taxi_30x30_map1", "officeworld": "office_36x36_map1", "waterworld": "water_"+str(gridsize[0])+"x"+str(gridsize[1])+"_map1", "lunarlander": "lunarlander", "cartpole": "cartpole"}
      ...
      for env_name in env_names:
        for exp in exps:
          for alg in algorithms:
            ...
            train_result_file = train_result_dir + map_names[env_name]+"_"+alg+"_"+str(runid)+".csv"
            ...
            new_callback = CustomStopTrainingCallback(episode_max)
