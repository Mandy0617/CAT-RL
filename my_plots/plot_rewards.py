...
if __name__=="__main__":
    ...
    fig,ax = plt.subplots(1,4,figsize =(10,1.75))
    ...
    domains_to_methods = {"waterworld": ['adrl','adrl'], "mountaincar": ['adrl','adrl'],"cartpole":['adrl','adrl'], "lunar":['adrl','adrl'] }

    method_to_names = {"adrl":"CA+RL "}
    
    dirpath = "./acc_rewards/"
    interval_episodes = 10
    colors = {'adrl': ['tab:green','tab:green']}
